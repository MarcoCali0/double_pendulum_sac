...
from sim_parameters import dt, goal, integrator, mpar, t0, t_final, x0
from simulation.simulation import Simulator
from utils.csv_trajectory import save_trajectory
...
def simulate_controller(controller, save_dir, controller_name=""):
    ...
    sim = Simulator(plant=plant, integrator_name="runge_kutta")
